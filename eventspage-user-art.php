...
$all = mysqli_query($conn,"SELECT * FROM event WHERE kategori='Art' LIMIT 27");
    ...
    <div class="main-content">
        <content-section>
                <upper-flex>
                    ...
                    <!-- <div class="subjudul"><a href="history-art.php">Histori</a></div> -->
                </upper-flex>
                <main>
                    <?php
        ...
        <div class="container-page">
            <?php
            for ($i = 1; $i <= $pages; $i++) { ?>
            <a class="page" href="?id=<?php echo $_GET['id']?>&page=<?php echo $i?>"><?php echo $i?></a>
            <?php } ?>
        </div>
    </div>
</center>
