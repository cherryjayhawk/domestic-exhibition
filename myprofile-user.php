...
$pengunjung = mysqli_query($conn, "SELECT * FROM pengunjung WHERE id_pengunjung='$_SESSION[id]'");
$data = mysqli_fetch_object($pengunjung);
?>
            ...
            <div class="sidebar">
                <ul>
                    ...
                    <li class="side-button">
                        ...
                        <a href="favorite-events.php?id=<?php echo $_GET['id'] ?>&page=1">Favorite Events</a>
                    </li>
                    <li class="side-button">
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="content">
                <div class="input">
                    <div class="input-items">
                        <input type="text" name="name" disabled="disabled" value="<?= $data->nama ?>" placeholder="Nama">
                    </div>
                    <div class="input-items">
                        <div class="input-top">
                            <div class="input-top-items" style="padding-right: 5px;">
                                <input type="email" name="email" disabled="disabled" value="<?= $data->email ?>" placeholder="Email">
                            </div>
                            <div class="input-top-items" style="padding-left: 5px;">
                                <input type="text" name="telp" disabled="disabled" value="<?= $data->telp ?>" placeholder="Phone Number">
                            </div>
                        </div>
                    </div>
                    <div class="input-items">
                        <div class="input-top">
                            <div class="input-right-items" style="padding-right: 5px;">
                                <input type="date" name="tgl_lahir" disabled="disabled" value="<?= $data->tgl_lahir ?>" placeholder="Birthdate">
                            </div>
                            <div class="input-top-items" style="padding-left: 5px;">
                                <input type="email" name="email" disabled="disabled" value="<?= $data->gender ?>" placeholder="Gender">
                            </div>
                        </div>
                    </div>
                    <div class="input-items">
                        <div class="input-bottom">
                            <div class="input-bottom-right">
                                <div class="input-bottom-right-items" style="padding-right: 5px;">
                                    <input type="email" name="email" disabled="disabled" value="<?= $data->region ?>" placeholder="Province">
                                </div>
                                <div class="input-bottom-right-items" style="padding-top: 40px; padding-right: 5px;">
                                    <input type="email" name="email" disabled="disabled" value="<?= $data->city ?>" placeholder="City">
                                </div>
                            </div>
                            <div class="input-botton-left" style="padding-left: 5px;">
                                <textarea name="address" disabled="disabled" placeholder="Address"></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="input-items">
                        <div class="input-items-button">
                            <button>
                                <a href='myprofile-user-edit.php?id=<?php echo $data->id_pengunjung ?>'>Edit</a>
                            </button>
                        </div>
                    </div>
                </div>
