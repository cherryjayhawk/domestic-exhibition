        ...
        <div class="content-items">
            <table class="list">
                <tr>
                    ...
                    <th>Poster</th>
                    <th>Deskripsi</th>
                    <th colspan="2">Event Start</th>
                    <th colspan="2">Event End</th>
                    <th>Region</th>
                    <th>City</th>
                    <th>Address</th>
                    <th>Action</th>
                ...
                // LEFT JOIN eventcat USING (id_category)
                ...
                <tr>
                    ...
                    <td align="center"> <?= $data['id_event'] ?> </td>
                    <td align="center"> <?= $data['kategori'] ?> </td>
                    <td align="center"> <?= $data['judul'] ?> </td>
                    <td align="center"> <img src="poster_event/<?= $data['poster']; ?>" alt="" width="50px"> </td>
                    <td align="center"> <?= $data['deskripsi'] ?> </td>
                    <td align="center"> <?= $data['event_start_date'] ?> </td>
                    <td align="center"> <?= $data['event_start_time'] ?> </td>
                    <td align="center"> <?= $data['event_end_date'] ?> </td>
                    <td align="center"> <?= $data['event_end_time'] ?> </td>
                    ...
                    // status 1 = aktif
                        if($data['status'] == "1"){
                            echo '<button class="delete"><a href="kelola-events-status.php?id_event='.$data['id_event'].'&status=0">Non-Aktif<a></button>';
                        } else {
                            echo '<button class="edit"><a href="kelola-events-status.php?id_event='.$data['id_event'].'&status=1">Aktif<a></button>';
                        }
                        ?>
                    </td>
                </tr>
