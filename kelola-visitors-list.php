    ...
    <section class="content">
        ...
        <div class="content-items">
            <table border class="list">
                ...
                $no = 1;
                $pengunjung = mysqli_query($conn, "SELECT * FROM pengunjung");
                
                // jika data/jumlah baris yg dicari query ada di tabel
                if (mysqli_num_rows($pengunjung) > 0){
                ...
                <tr>
                    ...
                    <td align="center"> <?= $data['id_pengunjung']; ?> </td>
                    ...
                    <td align="center">
                        ...
                        // status 1 = non-aktif
                        if($data['status'] == "0"){
                            echo '<button class="delete"><a href="kelola-visitors-status.php?id_pengunjung='.$data['id_pengunjung'].'&status=1">Non-Aktif<a></button>';
                        } else {
                            echo '<button class="edit"><a href="kelola-visitors-status.php?id_pengunjung='.$data['id_pengunjung'].'&status=0">Aktif<a></button>';
                        }
                        ?>
                    </td>
                </tr>
