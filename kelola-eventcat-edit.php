...
$eventcat = mysqli_query($conn, "SELECT * FROM eventcat WHERE id_category='$_GET[id_category]'");
// menyimpan object data dari query
$data = mysqli_fetch_object($eventcat);
?>
    ...
    <section class="content">
        ...
        <div class="content-items">
            ...
            if(isset($_POST["save"])){
                ...
                // query
                $update = mysqli_query($conn, "UPDATE eventcat SET nama='$nama' WHERE id_category='$_GET[id_category]'") or die(mysqli_error($conn)) ;
