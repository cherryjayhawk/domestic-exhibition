...
<body>
    ...
    <header>
        ...
        <a href=""><img src="logo_oren.png" class="logo"></a>
    </div>
    </header>
    ...
    <div class="kiri">
        <ul>
            ...
            <li name="profile">
                ...
                <a href="eo_profile.php">EO profile</a>
            </li>
            </div>
            <li name="event">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="eo_event.php">My Event</a>
            </li>
            <li name="withdraw">
                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <a href="eo_withdraw.php">Withdraw</a>
            </li>
            <li class="side-button">
                ...
                <a href="homepage-user.php">Log Out</a>
            </li>
        </ul>
    </div>
