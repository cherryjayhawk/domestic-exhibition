...
{	
    ...
    // update user data
    $result = mysqli_query($conn, "UPDATE pengunjung SET nama='$username',email='$email',telp='$telp',tgl_lahir='$tgl_lahir',gender='$gender',region='$region',city='$city',address='$address' WHERE id_pengunjung='$_SESSION[id]'");
    
    // Redirect to homepage to display updated user in list
    echo "<script>window.location.replace('myprofile-user.php?id=$id_user')</script>";
}
...
<body>
    ...
    <header>
        ...
        <a href="homepage-user.php?id=<?php echo $id_user ?>"><img src="icon\logo.png" class="logo"></a>
    </div>
    </header>
                    ...
                    <div class="input-items">
                        <div class="input-top">
                            ...
                            <div class="input-top-items" style="padding-left: 5px;">
                                <input type="text" name="telp" value="<?= $data->telp ?>" placeholder="Phone Number">
                            </div>
                        </div>
                    </div>
                    <div class="input-items">
                        <div class="input-top">
                            <div class="input-right-items" style="padding-right: 5px;">
                                <input type="date" name="tgl_lahir" value="<?= $data->tgl_lahir ?>" placeholder="Birthdate">
                            </div>
                            <div class="input-top-items" style="padding-left: 5px;">
                                <select name="gender" value="<?= $data->gender ?>" placeholder="Gender">
                        ...
                        <div class="input-bottom">
                            <div class="input-bottom-right">
                                <div class="input-bottom-right-items" style="padding-right: 5px;">
                                    <input name="region" value="<?= $data->region ?>" placeholder="Province">
                                </div>
                                <div class="input-bottom-right-items" style="padding-top: 40px; padding-right: 5px;">
                                    <input name="city" value="<?= $data->city ?>" placeholder="City">
                                </div>
                            </div>
