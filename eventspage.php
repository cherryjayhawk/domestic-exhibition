    ...
    <div class="main-content">
        ...
        <content-section >
                <upper-flex>
                    ...
                    <div><a href="eventspage-art.php" class="subjudul-view">View All ></a></div>
                </upper-flex>
                <content>
                    <?php
        ...
        <content-section>
                <upper-flex>
                    ...
                    <div><a href="eventspage-tech.php" class="subjudul-view">View All ></a></div>
                </upper-flex>
                <content>
                    <?php
        ...
        <content-section>
                <upper-flex>
                    ...
                    <div><a href="eventspage-food.php" class="subjudul-view">View All ></a></div>
                </upper-flex>
                <content>
                    <?php
        ...
        <content-section>
                <upper-flex>
                    ...
                    <div><a href="eventspage-automotive.php" class="subjudul-view">View All ></a></div>
                </upper-flex>
                <content>
                    <?php
            ...
            <content-section>
                <upper-flex>
                    ...
                    <div><a href="eventspage-fashion.php" class="subjudul-view">View All ></a></div>
                </upper-flex>
                <content>
                    <?php
            ...
            <content-section>
                <upper-flex>
                    ...
                    <div><a href="eventspage-books.php" class="subjudul-view">View All ></a></div>
                </upper-flex>
                <content>
                    <?php
            ...
            <content-section >
                <upper-flex>
                    ...
                    <div><a href="eventspage-others.php" class="subjudul-view">View All ></a></div>
                </upper-flex>
                <content>
                    <?php
